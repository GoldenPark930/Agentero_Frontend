        ...
        <div className='modal-dialog modal-dialog-centered' role='document'>
          <div className='modal-content'>
            <div className='modal-header'>
              ...
              <h5 className='modal-title c-gray fs28 font-light'>
                Agentero helps you grow your insurance agency.
              </h5>
              <button
                type='button'
                className='close'
            ...
            <div className='modal-body'>
              <form action='#' className='new-form-demo'>
                <p className='error-message fs16 c-white'>
                  <span className='font-bold'>Email:</span> Must be a valid
                  email: example@company.com{' '}
                </p>
                <div className='form-group'>
                  <input
                    type='text'
                    className='form-control fs16 c-gray'
                ...
                <div className='form-group'>
                  <div className='dropup'>
                    <button
                      type='button'
                      className='dropup-btn dropdown-toggle'
                      data-toggle='dropdown'
                      aria-haspopup='true'
                      aria-expanded='false'
                    >
                      <span className='info db fs11 c-gray'>
                        Which Agency Management System are you using?
                      </span>
                    ...
                    <div className='dropdown-menu'>
                      ...
                      <p className='fs14 c-gray dropup-txt'>
                        Not using any AMS
                      </p>
                    </div>
                  </div>
                ...
                <div className='form-group'>
                  <button
                    type='button'
                    className='btn btn__demo w-100 fs16 bgc-green c-white'
                  >
                    Request a demo
                  </button>
                </div>
