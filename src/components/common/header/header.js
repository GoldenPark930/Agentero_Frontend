...
class Header extends Component {
    ...
    toggleClass = (e) => {
        ...
        this.state.active = !currentState;
                        ...
                        <nav
                            ...
                            <div className="collapse  flex-lg-row-reverse  show" id="headerNavbar">
                                <ul className="nav-left roboto-font">
                                    ...
                                    <li className="nav-item mobile-border">
                                        <div className="nav-item__dropdown pr">
                                            ...
                                            <ul className="dropdown-menu">
                                                <li className="dropdown-item">
                                                    <Link
                                                    to="analytics" onClick={this.toggleClass}
                                                        className="fs16 c-custom-black  green text-decoration-none font-medium"
                                                    >Analytics
                                                    </Link>
                                                </li>
                                                <li className="dropdown-item">
                                                    <Link
                                                    to="mobile-app" onClick={this.toggleClass}
                                                        className="fs16 c-custom-black  green text-decoration-none font-medium"
                                                    >Mobile
                                                    </Link>
                                                </li>
                                    ...
                                    <li className="nav-item">
                                        <Link
                                        to="pricing" onClick={this.toggleClass}
                                    ...
                                    <li className="nav-item">
                                        <Link className=" nav-btn__demo  fs18 bgc-white c-lightGreen" to="requestdemo" onClick={this.toggleClass}>Request
                                            a demo</Link>
                                    </li>
                                </ul>
                            </div>
