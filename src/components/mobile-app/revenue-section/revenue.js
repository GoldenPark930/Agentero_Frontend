          ...
          <div className='row'>
            <div className='col-12'>
              <div className='max-w800 text-center mx-auto'>
                ...
                <p className='revenue-section__txt fs20 c-white roboto-font'>
                  A branded mobile app for your policyholders to manage all
                  their insurance, with your agency at the center.
                </p>
