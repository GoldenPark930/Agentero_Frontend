...
class Opinion extends Component {
  ...
  render() {
    ...
    if (isMobile) {
      if (isIOS) {
        MobileContent.push(
          <div key='IOS' className='d-lg-inline-block text-center'>
            <a
              href='https://agentero.app.link/5dzyf7wakH'
              className='btn btn__app'
              id='btnAppStore'
            >
              <svg
                className='svg-app'
      ...
      if (isAndroid) {
        MobileContent.push(
          <div key='Android' className='d-lg-inline-block text-center'>
            <a
              href='https://agentero.app.link/QhtX96PbkH'
              className='btn btn__app'
              id='btnGooglePlay'
            >
              <svg
      ...
      MobileContent.push(
        <div key='AppStore' className='d-lg-inline-block text-center'>
          <a
            id='btnAppStore'
            href='https://agentero.app.link/5dzyf7wakH'
            className='btn btn__app'
      ...
      MobileContent.push(
        <div key='GooglePlay' className='d-lg-inline-block text-center'>
          <a
            id='btnGooglePlay'
            href='https://agentero.app.link/QhtX96PbkH'
            className='btn btn__app'
          ...
          <div className='row'>
            <div className='col-12 text-center'>
              <div className='opinion-inner pr dib clearfix'>
                <svg
                  width='962px'
                  ref={this.messageAnimation}
                  className='quotes-svg'
                  xmlns='http://www.w3.org/2000/svg'
                ...
                <p className='message-txt left c-darkBlue fs18 font-medium text-center'>
                  “My family has so many insurance logins - auto (x2), renters,
                  life (x3), etc. Amazing to finally find a product that allows
                  me to see them all in one place”
                </p>

                <div className='opinion-user left d-flex align-items-center'>
                  <div className='d-flex_item'>
                    <LazyLoad height={87} debounce={false} offsetVertical={500}>
                      <div
                        className='opinion-user__img'
                        style={{ backgroundImage: `url(${user_img1})` }}
                      ></div>
                    </LazyLoad>
                  </div>
                  <div className='d-flex_item text-left'>
                    <h3 className='opinion-user__name fs30 c-darkBlue'>
                      Samuel M.
                    </h3>
                    <p className='opinion-user__role fs20 c-darkBlue'>
                      Policyholder
                    </p>
                  </div>
                </div>

                <p className='message-txt right c-darkBlue fs18 font-medium text-center'>
                  “Agentero empowers us to increase customer retention by
                  providing easy access to our agency and allowing clients to
                  manage their policies through the mobile app”
                </p>
                ...
                <div className='opinion-user right d-flex align-items-center'>
                  ...
                  <div className='d-flex_item'>
                    <LazyLoad height={87} debounce={false} offsetVertical={500}>
                      <div
                        className='opinion-user__img'
                        style={{ backgroundImage: `url(${user_img3})` }}
                      ></div>
                    </LazyLoad>
                  </div>
                </div>
